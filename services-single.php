...
if ($msg == TRUE):
    try {
        ...
        foreach ($rows as $value):
            ...
            $query = "UPDATE `services` SET `Visits` = ? WHERE `services`.`id` = ?;";
                ...
                <div class="page-title">
                    <div class="page-title-wrapper" data-stellar-background-ratio="0.5">
                        <div class="content container">
                            <h1 class="heading_primary"> <?php echo $Service; ?></h1>
                            <ul class="breadcrumbs">
                                <li class="item"><a href="index.php"><?php echo $singel->statement1; ?></a></li>
                                <li class="item"><span class="separator"></span></li>
                                <li class="item"><a href="index.php"><?php echo $Service; ?></a></li>
                                <li class="item"><span class="separator"></span></li>
                                <li class="item active"><?php echo $singel->statement2; ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <article class="post clearfix">
                                    <div class="post-content">
                                        <div class="post-media">
                                            <img src="cpanel/pages/layout/blog/uplod/<?php echo $Image; ?>" alt="">
                                        </div>
                                        <div class="post-summary">
                                            <h2 class="post-title"><?php echo $Service; ?></h2>
                                            <ul class="post-meta">
