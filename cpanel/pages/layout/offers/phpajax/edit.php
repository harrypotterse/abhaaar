...
if ($true == TRUE):
    ...
    $SQL = "UPDATE `offers` SET `Language` = ?, `Title` = ?, `Offer` = ?, `Explanation` = ?, `Image` = ? WHERE `offers`.`id` = ?;";
    $array = array($Language, $Title, $Offer,$Explanation,$target_path, $id);
