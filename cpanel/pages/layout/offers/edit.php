...
<html>
    <head>
        <meta charset="UTF-8">
        <title> تعديل البيانات # افضل العروض</title>
    ...
    <body class="skin-blue fixed sidebar-mini" dir="rtl">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="container">
                    <!-- Form Name -->
                    <legend> تعديل البيانات # افضل العروض</legend>
                               <?php require_once '../Component/prog.php';?>
                                        <div class="hover08 column"> <div> <figure> <img src="img/1.jpg" alt="" class="img-thumbnail"/></figure></div></div>
                            ...
                            <div class="col-xs-12">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input maxlength="100" type="text"  class="form-control input-lg nameads" name="Offer" placeholder=""  value="<?php echo $Offer; ?>"/>
                                    </div>
                                    <div class="form-group">
