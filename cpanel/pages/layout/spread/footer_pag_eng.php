...
$sql = "SELECT * FROM `page_components` where id=13";
$pag = new Component();
            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <div class="col-lg-offset-2 col-lg-10 col-lg-offset-2">
                        ...
                        <form role="form" action="phpajax/footer_pag_eng.php" id="uploadImage"  method="post">
                            <div class="row setup-content" id="step-1">
                                <div class="col-xs-12">
                                    <div class="col-md-12">
                                        <img src="img/footer_pag/1.png" class="img-thumbnail" alt=""/>
                                        <h3> Step 1</h3>
                            ...
                            <div class="row setup-content" id="step-2">
                                <div class="col-xs-12">
                                    <div class="col-md-12">
                                        <img src="img/footer_pag/2.png" class="img-thumbnail" alt=""/>
