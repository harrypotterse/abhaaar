...
$pag = new Component();
$sql = "SELECT * FROM `page_components` where id=4";
            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <div class="col-lg-offset-2 col-lg-10 col-lg-offset-2">
                        ...
                        <form role="form" action="../spread/phpajax/Registration_eng.php" id="uploadImage"  method="post">

                            <div class="row setup-content" id="step-1">
                                <div class="col-xs-12">
                                    <div class="col-md-12">
                                        <img src="img/elevators/1.JPG" class="img-thumbnail" alt=""/>
                                        <h3> Step 1</h3>
