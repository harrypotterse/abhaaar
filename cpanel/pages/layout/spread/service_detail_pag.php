...
$pag = new Component();
$row = $pag->fetchObject($Data_communication, "service_detail_pag");
?>
<!DOCTYPE html>
<html>
    <head>
            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <div class="col-lg-offset-2 col-lg-10 col-lg-offset-2">
                        ...
                        <form role="form" action="phpajax/service_detail_pag.php" id="uploadImage"  method="post">

                            <div class="row setup-content" id="step-1">
                                <div class="col-xs-12">
                                    <div class="col-md-12">
                                        <img src="img/service_detail_pag/1.JPG" class="img-thumbnail" alt=""/>
                                        <h3> Step 1</h3>
                            ...
                            <div class="row setup-content" id="step-2">
                                <div class="col-xs-12">
                                    <div class="col-md-12">
                                        <img src="img/service_detail_pag/2.JPG" class="img-thumbnail" alt=""/>
                            ...
                            <div class="row setup-content" id="step-3">
                                <div class="col-xs-12">
                                    <div class="col-md-12">
                                        <img src="img/service_detail_pag/3.JPG" class="img-thumbnail" alt=""/>
                                        <h3> Step 3</h3>
                                        <div class="form-group">
                                            <label>component </label>
                            ...
                            <div class="row setup-content" id="step-4">
                                <div class="col-xs-12">
                                    <div class="col-md-12">
                                        <img src="img/service_detail_pag/4.JPG" class="img-thumbnail" alt=""/>
                            ...
                            <div class="row setup-content" id="step-5">
                                <div class="col-xs-12">
                                    <div class="col-md-12">
                                        <img src="img/service_detail_pag/5.JPG" class="img-thumbnail" alt=""/>
