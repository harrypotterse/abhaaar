    ...
    <body class="skin-blue fixed sidebar-mini" dir="rtl">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="container">
                    <!-- Form Name -->
                    <legend> تعديل البيانات # المدونة</legend>
                                        ...
                                        <div class="form-group" style="display: none">
                                            ...
                                            <input type="hidden" name="file" value="<?php echo $Images; ?>" >
                                             ...
                                             <div class="form-group">
                                                    ...
                                                    <input maxlength="100" type="text"  class="form-control input-lg nameads" name="News" placeholder="العنوان" />

                                                </div>

                                                <div class="form-group">
                                                    <label for="comment">شرح مختصر</label>
                                                    <textarea class="form-control" rows="5" id="comment" name="Shortcut" required="تفاصيل الخبر"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <script src="//cdn.tinymce.com/4/tinymce.min.js"></script>
                                                    <script>tinymce.init({selector: '.textarea'});</script>
                                                    <label for="comment">التفاصيل</label>
                                                    <textarea class="textarea" name="Explanation" style="text-align: right;font-family: 'Cairo', sans-serif; font-size: 18px;" placeholder="اكتب الموضوع هنا"></textarea>
                                                </div>
