...
try {
    $SQL = "SELECT * FROM `best_offers`  where id = ?";
    $array = array($id);
...
<html>
    <head>
        <meta charset="UTF-8">
        <title> تعديل البيانات # أفضل العروض</title>
    ...
    <body class="skin-blue fixed sidebar-mini" dir="rtl">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="container">
                    <!-- Form Name -->
                    <legend> تعديل البيانات # أفضل العروض</legend>
                            ...
                            <div class="col-xs-12">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input maxlength="100" type="text"  class="form-control input-lg nameads" name="price" placeholder=""  value="<?php echo $price; ?>"/>
                                    </div>
                                    <div class="form-group">
