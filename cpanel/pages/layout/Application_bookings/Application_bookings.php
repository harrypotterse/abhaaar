...
<html lang="en">
    ...
    <body style="background: #38c6f3;">
        ...
        <div id="wrap">
            ...
            <div class="container">
                <div class="form-group">
                    ...
                    <div class="btn-group btn-group-justified asd">
                        <a href="#" class="btn btn-default asd">عدد الحجوزات <span class="badge"><?php
                                $sqls2 = "SELECT * FROM `bookings`  ";
                                echo rowCount($Data_communication, $sqls2, $today);
                                ?></span></a>
                        <a href="#" class="btn btn-default asd" data-toggle="modal" data-target="#myModal" >حجوزات اليوم <span class="badge"><?php
                                $today = date('Y-m-d');
                                $sqls = "SELECT * FROM `bookings` where di = ? ";
                                echo rowCount($Data_communication, $sqls, $today);
                                ?></span></a>
                        <a href="#" class="btn btn-default asd" data-toggle="modal" data-target="#myModal2">العنوان</a>
                    </div>
                </div>
            ...
            <!-- Modal -->
            <?php
            require_once './php/bookings_today.php';
            ;
            ?>
            <?php require_once './php/bookings_ADD.php' ?>
        </div>
    </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $(".op").change(function () {
                ...
                $.post('ajx/data.php', {data1: data1, data2: data2}, function (data) {
                    $('#tab').hide().html(data).fadeToggle("slow");
                    $("#example").DataTable();
                });
                return false;
            ...
            $(".Search").keyup(function () {
                var Search = $(this).val();
                $.post('ajx/Search.php', {Search: Search}, function (data) {
