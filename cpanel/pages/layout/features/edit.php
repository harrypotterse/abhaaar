...
<html>
    <head>
        <meta charset="UTF-8">
        <title> تعديل البيانات # المميزات</title>
    ...
    <body class="skin-blue fixed sidebar-mini" dir="rtl">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="container">
                    <!-- Form Name -->
                    <legend> تعديل البيانات #  التعليقات</legend>
                            ...
                            <div class="col-xs-12">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input maxlength="100" type="text" required="required" class="form-control input-lg NewsTitle"   placeholder=" من فضلك ضع رابط الصورة او الايكون هنا" name="Icons" value="<?php echo $Icons; ?>" />
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">العنوان</label>
                                        <input maxlength="100" type="text" required="required" class="form-control input-lg NewsTitle"  placeholder=" Function" name="Title" value="<?php echo $Title; ?>" />
                                    </div>
                                    <div class="form-group">
                                        <label> الشرح</label>
