...
<html>
    <head>
        <meta charset="UTF-8">
        <title> تعديل البيانات # المعرض</title>
    ...
    <body class="skin-blue fixed sidebar-mini" dir="rtl">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="container">
                    <!-- Form Name -->
                    <legend> تعديل البيانات #  المعرض</legend>
                    <div class="progress " >
                        ...
                        <div class="row setup-content" id="step-1">
                            <div class="col-xs-12">
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control Language" name="idg" id="sel1" style="height: 44px;font-size: 16px;font-weight: 600;">
                                        <?php
